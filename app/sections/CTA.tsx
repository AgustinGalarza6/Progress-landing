    ...
    return (
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button className="group px-10 py-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all active:scale-95 text-base flex items-center gap-2">
                Iniciar consultoría técnica
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </button>
                <button className="px-10 py-4 bg-transparent border border-white/20 rounded-lg font-medium text-base hover:bg-white/5 transition-all text-white/90">
                Ver casos de éxito
                </button>
            </div>
