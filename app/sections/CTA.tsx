...
export default function CTA() {
    return (
        <section id="cta" className="py-20 md:py-32 relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 className="text-[34px] md:text-6xl lg:text-7xl font-light text-white mb-6 leading-tight tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="https://wa.me/5491138923268" target="_blank" rel="noreferrer" className="group w-full sm:w-auto justify-center px-8 sm:px-10 py-4 bg-white text-black font-semibold rounded-lg hover:bg-gray-200 transition-all active:scale-95 text-base flex items-center gap-2 transform-gpu will-change-transform subpixel-antialiased antialiased shadow-sm" style={{ WebkitFontSmoothing: 'antialiased' }}>
                Solicitar diagnóstico
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </a>
                <a href="#exito" className="w-full sm:w-auto px-8 sm:px-10 py-4 bg-transparent border border-white/20 rounded-lg font-medium text-base hover:bg-white/5 transition-all text-white/90">
                Ver testimonios
                </a>
            </div>
